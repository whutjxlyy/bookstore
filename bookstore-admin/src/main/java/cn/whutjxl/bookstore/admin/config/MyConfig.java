package cn.whutjxl.bookstore.admin.config;
...
import cn.whutjxl.bookstore.admin.controllor.BookController;
import cn.whutjxl.bookstore.admin.controllor.IndexControllor;
import cn.whutjxl.bookstore.admin.controllor.OrderController;
import cn.whutjxl.bookstore.admin.controllor.UserController;
...
public class MyConfig extends JFinalConfig {
	...
	public void configRoute(Routes me) {
		...
		me.add("/book", BookController.class, "/WEB-INF/pages/books/");
		me.add("/user", UserController.class, "/WEB-INF/pages/users/");
